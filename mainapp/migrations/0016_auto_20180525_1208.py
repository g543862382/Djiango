# Generated by Django 2.0.5 on 2018-05-25 04:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0015_cart_deliveryaddress'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('order', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='订单号')),
                ('orderPrice', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('payStates', models.IntegerField(choices=[(0, '待支付'), (1, '已支付'), (2, '正在支付中')], default=0)),
                ('orderstates', models.IntegerField(choices=[(0, '待派送'), (1, '已派送'), (2, '已到达'), (3, '已签收'), (4, '拒收'), (5, '未到达')], default=0)),
